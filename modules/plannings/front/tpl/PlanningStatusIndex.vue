<template>
    <div class="planning_status_index">
        <div class="tablecontainer">
            <div class="actionbar">
                <button class="button button-add" v-on:click="addPlanningStatusModal">
                    <plus-icon/>
                    Add
                </button>
            ...
            <entity-table ref="table" :model="planningStatusModel" :definition="tableDefinition"
					...
					actions: [
						{
							...
							canDisplay: hasPermission('planning_status', 'delete')
						},
					]
				};
			},
