<template>
    <transition name="fade">
        <div class="editable">
            ...
            <div>
                <Datetime :zone="getUserOption('timezone')" :placeholder="this.placeholder" type="datetime" v-model="val" :disabled="!canupdate"></Datetime>&nbsp;<close-icon v-on:click="remove" v-if="this.val!== '' && this.val !== null" />
